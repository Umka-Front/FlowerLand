...
const SELECTOR_COMMAND = '[data-cmd]';
...
const SELECTOR_DATA_TOGGLE_DROPDOWN = '[data-toggle="dropdown"]';
const SELECTOR_DATA_TOOLTIP = '[data-tooltip="tooltip"]';
...
class Wysiwyg {
  ...
  _onInput() {
    EventHandler.on(this._content, EVENT_INPUT, () => {
      const textarea = SelectorEngine.prev(this._element, SELECTOR_TEXTAREA)[0];
